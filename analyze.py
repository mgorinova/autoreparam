...
cvip_methods = ["cVIP_exp", "cVIP_scale", 
								"cVIP_exp_reparam_variational"
							 ]
...
model_names = ["8schools_", "german_credit_lognormalcentered_", 
							 "radon_MA", "radon_AZ", "radon_IN", "radon_MO",
							 "radon_MN", "radon_PA", "radon_ND",
							 "election_", "electric_", "time_series_"]
